...
<div class="wrapper">
  ...
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand-md " style="background-color: #213C51">
    <div class="container">
      ...
      <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto " >
          <li class="nav-item">
            <a href="index.php" class="nav-link text-white rightBar" ><i class="fas fa-home"></i> HOME</a>
          </li>
          <li class="nav-item">
  ...
  <div class="content-wrapper" >
    ...
    <div class="content px-4" >
      <div class="container-fluid pt-5 "  style="background-color: rgba(22, 39, 73, 0.75);">
      <br>
      <br>
        <div class="row justify-content-center">
          <form id="loginForm" method="post">
          <div class="card " style="border: 10px solid rgba(70, 87, 122, 0.75); border-radius: 15px;">
