    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="incidentInfo.php" class="nav-link  bg-indigo">
          ...
          <div class="card">
              <div class="card-header">
                <div class="card-title">
                  <button type="button" class="btn bg-black elevation-5 px-3 btn-flat" id="buttonIncidentInfo" data-toggle="modal" data-target="#newModalPosition"><i class="fas fa-plus"></i> ADD Incident Info</button>
                </div>
              </div>
            <div class="card-body">
            <div class="row">
              ...
              <table class="table" id="incidentinfotable">
                <thead>
                  <tr>
                    <th>Incident Code</th>
...
<script>
  $(document).ready(function(){
    ...
    viewIncident();
    editStatus();
    function incidentinfotable(){
      var incidentinfotable = $("#incidentinfotable").DataTable({
        processing: true,
        serverSide: true,
        autoWidth: false,
        order:[[0,'desc']],
        ...
        ajax:{
          url: 'incidentInfoTable.php',
          type: 'POST',
          dataSrc: function(json){
            if (json.error) {
              console.error('incidentInfoTable error:', json.error);
              return [];
            }
            return json.data;
          }
      ...
      $('#searching').keyup(function(){
        incidentinfotable.search($(this).val()).draw() ;
      })
    }
    ...
    function editStatus(){
      ...
      var data_status = $(this).attr('data-status');
        ...
        $.ajax({
            url: 'editStatusIncidentInfo.php',
            type: 'POST',
            cache: false,
            data: {
            ...
            success:function(data){
              $("#incidentinfotable").DataTable().ajax.reload(null, false);
            }
        }).fail(function(){
          Swal.fire({
    ...
    function viewIncident(){
      $(document).on('click','.viewIncident',function(){
      var incident_id = $(this).attr('id');

        $("#displayPosition").html('');
        
        $.ajax({
          url: 'viewIncidentModal.php',
          type: 'POST',
          dataType: 'html',
          cache: false,
          data: {
            ...
            $.ajax({
              ...
              success:function(response){
                ...
                Swal.fire({
                  ...
                  icon: 'success',
                  html: '<b>Incident info added successfully<b>',
                  timer: 2000,
    ...
    $(document).on('click','#buttonIncidentInfo', function(){
      $("#newPositionForm")[0].reset();
    })

    $(document).on('submit', '#editIncidentForm', function(e){
      e.preventDefault();
      var $form = $(this);
    ...
    $(document).on('click','.deleteIncident',function(){
      ...
      Swal.fire({
        ...
        html: "<b>You want delete this Incident Info?</b>",
        type: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
            ...
            success:function(data){
              ...
              if(data == 'error'){
                ...
                Swal.fire({
                  title: '<strong class="text-danger">ERROR</strong>',
                  type: 'error',
                  html: '<b>This Incident record cannot be deleted<b>',
                  width: '400px',
                  allowOutsideClick: false,
                })
                  ...
                  Swal.fire({
                    title: '<strong class="text-success">Success</strong>',
                    type: 'success',
                    html: '<b>Incident info deleted successfully<b>',
                    width: '400px',
                    showConfirmButton: false,
                    allowOutsideClick: false,
                    timer: 2000
